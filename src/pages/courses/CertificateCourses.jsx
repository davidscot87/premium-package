...
import { Search, Clock, Users, Award, CheckCircle, ArrowRight, Grid, List, BookOpen } from 'lucide-react'
...
const CertificateCourses = () => {
  ...
  const categories = ['all', ...new Set(certificateCourses.map(p => p.category))]
  ...
  const totalSeats = certificateCourses.reduce((sum, c) => sum + c.seats, 0)
  ...
  return (
    <div className="category-page">
      <section 
        ...
        style={{
          backgroundImage: `url(https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=2400&h=1600&fit=crop&q=85)`
        }}
      >
        <div className="container-custom">
          <div className="category-hero-content">
            ...
            <p>Upskill quickly with focused certificate programs designed for working professionals and career changers</p>
            <div className="category-stats">
              <div className="category-stat">
                <span className="category-stat-value">{certificateCourses.length}</span>
              ...
              <div className="category-stat">
                <span className="category-stat-value">3-6 Mo</span>
              ...
              {filteredCourses.map((course) => (
                <div key={course.id} className="course-card">
                  <div className="course-image">
                    ...
                    <div className="course-badge">Fast Track</div>
                  </div>
